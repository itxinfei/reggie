...
VALUES
  (200, 'PAYC001', 1, 1, 1, CURRENT_TIMESTAMP, 99.99, '测试用户', '13800000010', '测试地址', '张三', 'OUTSIDE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 999, 0),
  (201, 'PAYC002', 1, 1, 1, CURRENT_TIMESTAMP, 50.00, '测试用户', '13800000011', '测试地址', '李四', 'OUTSIDE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 999, 0),
  (202, 'PAYC003', 1, 1, 1, CURRENT_TIMESTAMP, 200.00, '测试用户', '13800000012', '测试地址', '王五', 'OUTSIDE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 999, 0);
