...
CREATE TABLE dish_cost (
  ...
  sale_price decimal(10,2) NULL DEFAULT NULL COMMENT '唻',
...
CREATE TABLE cost_record (
  ...
  amount decimal(10,2) NULL DEFAULT NULL COMMENT '成本金',
...
CREATE TABLE labor_cost (
  ...
  social_insurance decimal(10,2) NULL DEFAULT NULL COMMENT '籣',
  housing_fund decimal(10,2) NULL DEFAULT NULL COMMENT '內',
