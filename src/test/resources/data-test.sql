...
(1, 'ORD20260101001', 'COMPLETED', 1, 1, DATE_SUB(NOW(), INTERVAL 5 DAY), DATE_SUB(NOW(), INTERVAL 5 DAY) + INTERVAL 1 HOUR, 1, 328.00, '少辣', '13900139001', '北京市东城区王府井大街1号', '张小明', '张小明', NULL, 'DELIVERY'),
(2, 'ORD20260102001', 'COMPLETED', 2, 3, DATE_SUB(NOW(), INTERVAL 4 DAY), DATE_SUB(NOW(), INTERVAL 4 DAY) + INTERVAL 1 HOUR, 2, 156.00, NULL, '13900139002', '上海市徐汇区南京路100号', '李晓红', '李晓红', NULL, 'DELIVERY'),
(3, 'ORD20260103001', 'COMPLETED', 3, NULL, DATE_SUB(NOW(), INTERVAL 3 DAY), DATE_SUB(NOW(), INTERVAL 3 DAY) + INTERVAL 2 HOUR, 1, 858.00, '商务宴请', '13900139003', NULL, '王大军', '王大军', 12, 'DINING'),
(4, 'ORD20260104001', 'COMPLETED', 4, 5, DATE_SUB(NOW(), INTERVAL 2 DAY), DATE_SUB(NOW(), INTERVAL 2 DAY) + INTERVAL 1 HOUR, 3, 89.00, '快一点', '13900139004', '成都市锦江区春熙路88号', '赵小美', '赵小美', NULL, 'DELIVERY'),
(5, 'ORD20260105001', 'COMPLETED', 5, NULL, DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY) + INTERVAL 3 HOUR, 1, 2580.00, '豪华配置', '13900139005', NULL, '孙悟空', '孙悟空', 14, 'DINING'),
(6, 'ORD20260106001', 'PENDING', 6, 6, NOW(), NULL, 1, 168.00, NULL, '13900139006', '深圳市南山区科技园', '猪八戒', '猪八戒', NULL, 'DELIVERY'),
(7, 'ORD20260107001', 'COMPLETED', 7, NULL, DATE_SUB(NOW(), INTERVAL 12 HOUR), DATE_SUB(NOW(), INTERVAL 12 HOUR) + INTERVAL 2 HOUR, 2, 398.00, '朋友聚餐', '13900139007', NULL, '沙和尚', '沙和尚', 3, 'DINING'),
(8, 'ORD20260108001', 'CANCELLED', 8, 7, DATE_SUB(NOW(), INTERVAL 10 HOUR), NULL, NULL, 258.00, '取消订单', '13900139008', '杭州市上城区西湖路1号', '白骨精', '白骨精', NULL, 'DELIVERY'),
(9, 'ORD20260109001', 'COMPLETED', 9, NULL, DATE_SUB(NOW(), INTERVAL 8 HOUR), DATE_SUB(NOW(), INTERVAL 8 HOUR) + INTERVAL 2 HOUR, 1, 1880.00, '生日宴', '13900139009', NULL, '唐三藏', '唐三藏', 17, 'DINING'),
(10, 'ORD20260110001', 'COMPLETED', 10, 11, DATE_SUB(NOW(), INTERVAL 6 HOUR), DATE_SUB(NOW(), INTERVAL 6 HOUR) + INTERVAL 1 HOUR, 2, 580.00, NULL, '13900139010', '杭州市西湖区雷峰塔', '白素贞', '白素贞', NULL, 'DELIVERY'),
(11, 'ORD20260111001', 'COMPLETED', 11, 12, DATE_SUB(NOW(), INTERVAL 4 HOUR), DATE_SUB(NOW(), INTERVAL 4 HOUR) + INTERVAL 1 HOUR, 1, 328.00, NULL, '13900139011', '杭州市西湖区断桥', '小青', '小青', NULL, 'TAKEOUT'),
(12, 'ORD20260112001', 'COMPLETED', 12, 13, DATE_SUB(NOW(), INTERVAL 2 HOUR), DATE_SUB(NOW(), INTERVAL 2 HOUR) + INTERVAL 1 HOUR, 3, 168.00, '少冰', '13900139012', '杭州市西湖区保俶塔', '许仙', '许仙', NULL, 'TAKEOUT'),
(13, 'ORD20260113001', 'PENDING', 13, NULL, NOW(), NULL, 1, 1280.00, '公司聚餐', '13900139013', NULL, '法海', '法海', 11, 'DINING'),
(14, 'ORD20260114001', 'COMPLETED', 14, 15, DATE_SUB(NOW(), INTERVAL 1 HOUR), DATE_SUB(NOW(), INTERVAL 1 HOUR) + INTERVAL 1 HOUR, 2, 458.00, NULL, '13900139014', '沈阳市和平区北陵', '林黛玉', '林黛玉', NULL, 'DELIVERY'),
(15, 'ORD20260115001', 'COMPLETED', 15, NULL, DATE_SUB(NOW(), INTERVAL 30 MINUTE), DATE_SUB(NOW(), INTERVAL 30 MINUTE) + INTERVAL 1 HOUR, 1, 688.00, '朋友聚会', '13900139015', NULL, '贾宝玉', '贾宝玉', 2, 'DINING');
