...
CREATE TABLE address_book (
  ...
  building varchar(20) NULL DEFAULT NULL COMMENT '楼栋',
  unit varchar(20) NULL DEFAULT NULL COMMENT '单元',
  floor varchar(20) NULL DEFAULT NULL COMMENT '楼层',
  room_no varchar(20) NULL DEFAULT NULL COMMENT '门牌号',
