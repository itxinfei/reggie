...
/**
 * 新增优惠券模板 DTO
 * <p>仅包含前端需要填写的业务字段，tenantId / id / isDeleted / 时间戳等敏感字段
 ...
 */
@Data
@Schema(description = "新增优惠券模板请求")
public class CouponTemplateSaveDTO implements Serializable {
    ...
    @Schema(description = "优惠券类型：FULL_REDUCTION=满减券，DISCOUNT=折扣券，NEW_MEMBER=新客券")
